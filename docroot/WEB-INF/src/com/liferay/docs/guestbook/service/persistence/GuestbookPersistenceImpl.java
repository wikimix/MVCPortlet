...
public class GuestbookPersistenceImpl extends BasePersistenceImpl<Guestbook>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_G = new FinderPath(GuestbookModelImpl.ENTITY_CACHE_ENABLED,
			GuestbookModelImpl.FINDER_CACHE_ENABLED, GuestbookImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_G = new FinderPath(GuestbookModelImpl.ENTITY_CACHE_ENABLED,
			GuestbookModelImpl.FINDER_CACHE_ENABLED, GuestbookImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_G",
			new String[] { Long.class.getName(), Long.class.getName() },
			GuestbookModelImpl.GROUPID_COLUMN_BITMASK |
			GuestbookModelImpl.GUESTBOOKID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_G = new FinderPath(GuestbookModelImpl.ENTITY_CACHE_ENABLED,
			GuestbookModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_G",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the guestbooks where groupId = &#63; and guestbookId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Guestbook> findByG_G(long groupId, long guestbookId)
		throws SystemException {
	...
	/**
	 * Returns a range of all the guestbooks where groupId = &#63; and guestbookId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.docs.guestbook.model.impl.GuestbookModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Guestbook> findByG_G(long groupId, long guestbookId, int start,
		int end) throws SystemException {
		return findByG_G(groupId, guestbookId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the guestbooks where groupId = &#63; and guestbookId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.docs.guestbook.model.impl.GuestbookModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first guestbook in the ordered set where groupId = &#63; and guestbookId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param guestbookId the guestbook ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Guestbook findByG_G_First(long groupId, long guestbookId,
		OrderByComparator orderByComparator)
		throws NoSuchGuestbookException, SystemException {
		Guestbook guestbook = fetchByG_G_First(groupId, guestbookId,
				orderByComparator);
	 ...
	 */
	@Override
	public Guestbook fetchByG_G_First(long groupId, long guestbookId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Guestbook> list = findByG_G(groupId, guestbookId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last guestbook in the ordered set where groupId = &#63; and guestbookId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param guestbookId the guestbook ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Guestbook findByG_G_Last(long groupId, long guestbookId,
		OrderByComparator orderByComparator)
		throws NoSuchGuestbookException, SystemException {
		Guestbook guestbook = fetchByG_G_Last(groupId, guestbookId,
				orderByComparator);
	 ...
	 */
	@Override
	public Guestbook fetchByG_G_Last(long groupId, long guestbookId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Guestbook> list = findByG_G(groupId, guestbookId, count - 1,
	...
	/**
	 * Removes all the guestbooks where groupId = &#63; and guestbookId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param guestbookId the guestbook ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByG_G(long groupId, long guestbookId)
		throws SystemException {
		for (Guestbook guestbook : findByG_G(groupId, guestbookId,
	...
	/**
	 * Returns the number of guestbooks where groupId = &#63; and guestbookId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param guestbookId the guestbook ID
	 * @return the number of matching guestbooks
	...
	private static final String _FINDER_COLUMN_G_G_GROUPID_2 = "guestbook.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_G_GUESTBOOKID_2 = "guestbook.guestbookId = ?";
	...
	public Guestbook updateImpl(
		...
		if (isNew || !GuestbookModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((guestbookModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						guestbookModelImpl.getOriginalGroupId(),
						guestbookModelImpl.getOriginalGuestbookId()
					};
				...
				args = new Object[] {
						...
						guestbookModelImpl.getGuestbookId()
					};
